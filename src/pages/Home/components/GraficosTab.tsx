 ...
 *            estilo plataforma flutuante.
 * ----------------------------------------------------------------------------
 * PADRÃO DE DESIGN:
 * - As barras dos gráficos utilizam Azul/Índigo (`bg-indigo-600` / `bg-blue-600`).
 * ============================================================================
 */
...
export const GraficosTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      {/* 1. SEÇÃO DE FILTROS & AGRUPAMENTO COM CARD FLUTUANTE */}
      <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xl shadow-slate-200/50 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2">
          <div>
            ...
            <select className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-800 focus:bg-white focus:border-blue-600 focus:outline-none">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-1/2 px-2.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-800 focus:bg-white focus:border-blue-600 focus:outline-none"
              />
              <input
                type="text"
      ...
      {/* 2. GRÁFICO DE BARRAS AZUIS DA QUANTIDADE DE PRODUTOS */}
      <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xl shadow-slate-200/50 space-y-4">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          ...
          <span className="text-xs text-slate-500 font-medium">Quantidade de Produtos</span>
        </div>
          ...
          {currentData.map((item, idx) => {
            ...
            return (
              <div key={idx} className="flex items-center text-xs">
                ...
                <div className="flex-1 bg-slate-100 h-8 rounded-lg overflow-hidden flex items-center p-0.5 relative border border-slate-200/80">
                  <div
